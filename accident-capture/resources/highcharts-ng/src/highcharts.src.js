...
SVGElement.prototype = {
	...
	/**
	 * Build an SVG gradient out of a common JavaScript config object
	 */
...
var VMLRendererExtension = { // inherit SVGRenderer
	 ...
	 * gradient config object, and apply opacity.
	 *
...
AxisPlotLineOrBandExtension = {
	 ...
	 *
	 * @param options {Object} The plotBand or plotLine config object
	 */
...
/**
 * Get a normalized tick interval for dates. Returns a config object with
...
Chart.prototype = {
	 ...
	 * @param id {String} The id as given in the config options
	 */
	get: function (id) {
		var chart = this,
			axes = chart.axes,
...
Point.prototype = {
	...
	/**
	 * Return the config hash needed for the data label and tooltip formatters
	 */
...
function StackItem(axis, options, isNegative, x, stackOption) {
	...
	// Save the stack option on the series config object, and whether to treat it as percent
